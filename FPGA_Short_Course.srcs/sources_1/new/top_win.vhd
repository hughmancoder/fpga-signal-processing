...
architecture schematic of top_win is
    ...
    -- modified
    signal w_win_last      : std_logic; 
    signal w_win_adc       : std_logic_vector(15 downto 0);

    attribute mark_debug : string;
    attribute mark_debug of w_fft_tlast_out : signal is "true";
    attribute mark_debug of w_fft_data_i    : signal is "true";
    attribute mark_debug of w_fft_data_q    : signal is "true";
    attribute mark_debug of w_mag           : signal is "true";


    attribute mark_debug of w_adc      : signal is "true";
    attribute mark_debug of w_win_adc  : signal is "true";
...
begin
    ...
    begin
        if (i_rst = '1') then
            ...
            if (f_adc_cnt = 1023) then -- bits overflow after back to 0
                f_fft_tlast_in <= '1';
            else
                f_fft_tlast_in <= '0';
            end if;
    ...
    Port map(
        ...
        i_rst      =>  i_rst,
        i_adc      => w_adc,
        o_win_last => w_win_last,
        o_win_adc  => w_win_adc
    );

    w_fft_tdata_in <= x"0000" & w_win_adc; -- 32 bits
    -- w_fft_tdata_in <= w_win_adc;
    ...
    w_cordic_din <= "00000" & w_fft_data_i & "00000" & w_fft_data_q;
